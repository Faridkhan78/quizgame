...
<body>
       ...
       <section class="section-1 d-flex" id="section-1">
        <div class="timer-container">
            ...
            <svg>
                ...
                <text class="timer-number" id="timer-number-1" x="100" y="110" text-anchor="middle" alignment-baseline="middle">50</text>
            </svg>
        </div>
        <main>
    ...
    <section class="section-2 d-flex" id="section-2" style="display: none;">
        <div class="timer-container">
            <div class="inner-circle"></div>
            <svg>
                <circle class="progress-ring" id="progress-ring-2" r="90" cx="100" cy="100"></circle>
                <text class="timer-number" id="timer-number-2" x="100" y="110" text-anchor="middle" alignment-baseline="middle">50</text>
            </svg>
        </div>
        <main>
            <div class="text-container">
