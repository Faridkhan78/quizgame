...
<style>
  ...
  input:focus{
    border: 0.5px solid #3c9;
    outline: 1px solid #3c9;
  }

  input[type="radio"]:focus {
  border-color: #3c9; /* Apply green border color when focused */
  outline: 2px solid #3c9; /* Create a clear focus outline */
}

input[type="radio"]:checked {
  background-color: #3c9; /* Highlight selected radio button */
}
...
{{-- 
       <section class="section-1 d-flex" id="section-1">
        ...
        <main>
            <div class="text-container">
                <p id="question-text">QUESTION 1 OF 5</p>
            </div>
            <form id="quiz-form">
    ...
    <script>
        const questions = [
            {
                ...
                options: [
                    ...
                    { text: "Creative Screen Styling", isCorrect: false },
                    { text: "Cascading Style Screen", isCorrect: false }
                ]
            }
        ...
        function renderQuestion(questionIndex) {
            ...
            question.options.forEach((option, index) => {
                const optionHTML = `
                    <input type="radio" id="option-${index}" name="question-${questionIndex}" value="${option.isCorrect ? 'correct' : 'incorrect'}" required>
                    <label for="option-${index}"><span class="alphabet">${String.fromCharCode(65 + index)}</span> ${option.text}</label>
                `;
    ...
    <section class="section-1 d-flex" id="section-1">
        ...
        <main>
            <div class="text-container">
                {{-- <h3>Pure CSS Quiz</h3> --}}
                <p>QUESTION 1 OF 5</p>
                <p><b>What does CSS stand for?</b></p>
            </div>
            <form>
                <div class="quiz-options">
                    ...
                    <input type="radio" id="one-b" name="yes-1">
                    <label for="one-b"><span class="alphabet">B</span> Creative Screen Styling</label>
                    <input type="radio" id="one-c" name="yes-1">
    ...
    <section class="section-2 d-flex" id="section-2">
        <div class="timer-container">
            <div class="inner-circle"></div>
            <svg>
                <circle class="progress-ring" id="progress-ring-2" r="90" cx="100" cy="100"></circle>
                <text class="timer-number" id="timer-number-2" x="100" y="110" text-anchor="middle"
                    alignment-baseline="middle">50</text>
            </svg>
        </div>
        <main>
            <div class="text-container">
                {{-- <h3>Pure CSS Quiz</h3> --}}
                <p>QUESTION 2 OF 5</p>
                <p><b>To specify the transparency of an element, you can use?,</b></p>
            </div>
            
            <form>
                <div class="quiz-options">
                    <input type="radio" id="two-a" name="no-2" required>
                    <label for="two-a"><span class="alphabet">A</span> trans-parency</label>
                    <input type="radio" id="two-b" name="no-2" required>
                    <label for="two-b"><span class="alphabet">B</span> color: 0;</label>
                    <input type="radio" id="two-c" name="no-2" required>
                    <label for="two-c"><span class="alphabet">C</span> opacity</label>
                </div>
                <a id="btn" onclick="goToNextSection()">Next</a>
            </form>
        </main>
    ...
    <section class="section-3 d-flex" id="section-3">
        ...
        <main>
            <div class="text-container">
                {{-- <h3>Pure CSS Quiz</h3> --}}
                <p>QUESTION 3 OF 5</p>
                <p><b>which of these is not a category of CSS selectors?</b></p>
            </div>
            <form>
                <div class="quiz-options">
                    <input type="radio" class="input-radio three-a jshdgdgwgdwfdfwdwjfdjwwdwdin" id="three-a"
                        name="no-3" required="">
                    <label class="radio-label jsjwjdwjdwjdwin" for="three-a">
                        <span class="alphabet">A</span> Pseudo-class selectors <img class="icon jfdedgwfzexf4hjin"
                            src="https://res.cloudinary.com/dvhndpbun/image/upload/v1588517753/jfdedgwfzexf4hjin.svg">
                    </label>
                    <input type="radio" class="input-radio three-b jshdgdgwgdwfdfwdwjfdjwwdwdin" id="three-b"
                        name="no-3" required="">
                    <label class="radio-label jsjwjdwjdwjdwin" for="three-b">
                        <span class="alphabet">B</span> Simple selectors <img class="icon jfdedgwfzexf4hjin"
                            src="https://res.cloudinary.com/dvhndpbun/image/upload/v1588517753/jfdedgwfzexf4hjin.svg">
                    </label>
                    <input type="radio" class="input-radio three-c jshdgdgwgdwfdfwdwjfdjwwdwdco" id="three-c"
                        name="no-3" required="">
                    <label class="radio-label jsjwjdwjdwjdwco" for="three-c">
                        <span class="alphabet">C</span> Layout-selector <img class="icon jdsjkefkefkefefexco"
    ...
    <section class="section-4 d-flex" id="section-4">
        ...
        <main>
            <div class="text-container">
                {{-- <h3>Pure CSS Quiz</h3> --}}
                <p>QUESTION 4 OF 5</p>
                <p><b>The browser vertical scrollbar can be hidden by using which of the following property?</b></p>
            </div>
            <form>
                <div class="quiz-options">
                    <input type="radio" class="input-radio four-a jshdgdgwgdwfdfwdwjfdjwwdwdin" id="four-a"
                        name="no-4" required="">
                    <label class="radio-label jsjwjdwjdwjdwin" for="four-a">
                        <span class="alphabet">A</span> scrollbar: disable; <img class="icon jfdedgwfzexf4hjin"
                            src="https://res.cloudinary.com/dvhndpbun/image/upload/v1588517753/jfdedgwfzexf4hjin.svg">
                    </label>
                    <input type="radio" class="input-radio four-b jshdgdgwgdwfdfwdwjfdjwwdwdco" id="four-b"
                        name="no-4" required="">
                    <label class="radio-label jsjwjdwjdwjdwco" for="four-b">
                        <span class="alphabet">B</span> overflow-y: hidden; <img class="icon jdsjkefkefkefefexco"
                            src="https://res.cloudinary.com/dvhndpbun/image/upload/v1588518387/jdsjkefkefkefefexco.svg">
                    </label>
                    <input type="radio" class="input-radio four-c jshdgdgwgdwfdfwdwjfdjwwdwdin" id="four-c"
                        name="no-4" required="">
                    <label class="radio-label jsjwjdwjdwjdwin" for="four-c">
                        <span class="alphabet">C</span> overflow-x: hidden <img class="icon jfdedgwfzexf4hjin"
                            src="https://res.cloudinary.com/dvhndpbun/image/upload/v1588517753/jfdedgwfzexf4hjin.svg">
                    </label>
                </div>
    ...
    <section class="section-5 d-flex" id="section-5">
        ...
        <main>
            <div class="text-container">
                {{-- <h3>Pure CSS Quiz</h3> --}}
                <p>QUESTION 5 OF 5</p>
                <p><b>What does HTML stand for?</b></p>
            </div>
            <form>
                <div class="quiz-options">
                    <input type="radio" class="input-radio five-a jshdgdgwgdwfdfwdwjfdjwwdwdco" id="five-a"
                        name="yes-5" required>
                    <label class="radio-label jsjwjdwjdwjdwco" for="five-a">
                        <span class="alphabet">A</span> Hypertext Markup Language <img
                            class="icon jdsjkefkefkefefexco"
                            src="https://res.cloudinary.com/dvhndpbun/image/upload/v1588518387/jdsjkefkefkefefexco.svg"
                            alt="">
                    </label>
                    <input type="radio" class="input-radio five-b jshdgdgwgdwfdfwdwjfdjwwdwdin" id="five-b"
                        name="yes-5">
                    <label class="radio-label jsjwjdwjdwjdwin" for="five-b">
                        <span class="alphabet">B</span> Hypertext Transform Markup Language <img
                            class="icon jfdedgwfzexf4hjin"
                            src="https://res.cloudinary.com/dvhndpbun/image/upload/v1588517753/jfdedgwfzexf4hjin.svg">
                    </label>
                    <input type="radio" class="input-radio five-c jshdgdgwgdwfdfwdwjfdjwwdwdin" id="five-c"
                        name="yes-5">
                    <label class="radio-label jsjwjdwjdwjdwin" for="five-c">
                        <span class="alphabet">C</span> Hypertext Machine Language <img class="icon jfdedgwfzexf4hjin"
                            src="https://res.cloudinary.com/dvhndpbun/image/upload/v1588517753/jfdedgwfzexf4hjin.svg">
                    </label>
                </div>
...
<script>
    ...
    // Section 1 elements
    var timerDisplay1 = document.getElementById('timer-number-1');
    var circle1 = document.getElementById('progress-ring-1');
    var circumference1 = circle1.getTotalLength(); // Total length of the circle's stroke

    // Set the stroke-dasharray and initial stroke-dashoffset for section 1
    circle1.style.strokeDasharray = circumference1;
    circle1.style.strokeDashoffset = circumference1;

    // Function to update timer for section 1
    function updateTimer(timeLeft) {
        timerDisplay1.textContent = timeLeft; // Update timer number

        // Calculate new stroke-dashoffset to reduce the circle
        var offset = circumference1 - (timeLeft / timeLimit) * circumference1;
        circle1.style.strokeDashoffset = offset;

        // Debugging: Show current time left in console
    ...
    var countdown = setInterval(function() {
        if (timeLeft >= 0) {
            ...
            console.log("Timer Finished. Moving to Section 2...");
            goToNextSection(); // Move to the next section
        }
    }, 1000); // Timer updates every second (1000ms)

    // Function to transition from section 1 to section 2
    function goToNextSection() {
        // Debugging: Check if this function is being called
        console.log("goToNextSection Called");

        // Hide the current section (section-1)
        document.getElementById('section-1').style.display = 'none';

        // Show the next section (section-2)
        document.getElementById('section-2').style.display = 'block';

        // Setup for section 2
        var timerDisplay2 = document.getElementById('timer-number-2');
        var circle2 = document.getElementById('progress-ring-2');
        var circumference2 = circle2.getTotalLength(); // Total length of the circle's stroke

        // Set the stroke-dasharray and initial stroke-dashoffset for section 2
        circle2.style.strokeDasharray = circumference2;
        circle2.style.strokeDashoffset = circumference2;

        // Debugging: Confirm that section 2 is displayed
        console.log("Section 2 displayed, setup done.");
    }
</script>
...
{{-- </div> --}}
{{-- <script>
    var timeLimit = 5; // Total time for each section

function startTimer(sectionId) {
    var timeLeft = timeLimit; // Reset time for each section
    var timerDisplay = document.querySelector(`#quiz-section-${sectionId} .timer-number`);
    var circle = document.querySelector(`#quiz-section-${sectionId} .progress-ring circle`);
    var circumference = circle.getTotalLength(); // Total length of the circle's stroke
...
function checkAnswer(sectionId) {
    var selectedAnswer = document.querySelector(`#quiz-section-${sectionId} input[name="yes-${sectionId}"]:checked`);

    if (selectedAnswer) {
        if (selectedAnswer.value === "correct") {
            alert("Correct answer! Moving to the next section.");
...
function nextSection(currentSectionId) {
    var currentSection = document.getElementById(`quiz-section-${currentSectionId}`);
    var nextSectionId = currentSectionId + 1;
    var nextSection = document.getElementById(`quiz-section-${nextSectionId}`);

    if (nextSection) {
        currentSection.style.display = 'none'; // Hide current section
        nextSection.style.display = 'block';  // Show next section
        startTimer(nextSectionId); // Start the timer for the next section
    } else {
...
document.addEventListener('DOMContentLoaded', function() {
    startTimer(1); // Start timer for section 1
});
