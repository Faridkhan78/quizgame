...
<body>
                ...
                <div class="container mt-3">
                    ...
                    <form action="">
                        <div class="quiz-options">
                            ...
                            <input type="radio" class="input-radio one-a jshdgdgwgdwfdfwdwjfdjwwdwdco" id="one-a"
                                name="yes-1" required>
                            <label class="radio-label jsjwjdwjdwjdwco" for="one-a">
                                <span class="alphabet">A</span> {{ $user['option1'] }} <img
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="check1">{{ $user['option1'] }}</label>
                            </div>
                            ...
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="check2" name="option2"
                                    value="something">
                                <label class="form-check-label" for="check2">{{ $user['option2'] }}</label>
                            </div>
                            ...
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="check2" name="option2"
                                    value="something">
                                <label class="form-check-label">{{ $user['option3'] }}</label>
                            </div>
                            ...
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="check2" name="option2"
                                    value="something">
                                <label class="form-check-label">{{ $user['option4'] }}</label>
                            </div>
                        </div>
    ...
    @if ($users->hasMorePages())
        <a href="{{ $users->nextPageUrl() }}" class="btn btn-primary mt-3">Next</a>
    @else
        <a href="#" class="btn btn-primary mt-3 disabled">Submit</a>
    @endif
